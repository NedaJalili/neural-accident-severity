...
if __name__ == "__main__":
    file_path = '/content/drive/MyDrive/neural-accident-severity/data/accidents_cleaned_khatkeshi_step8.csv'
    output_txt_path = '/content/drive/MyDrive/neural-accident-severity/data/extract_id_meanings_step9.txt'
